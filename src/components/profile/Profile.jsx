...
const Profile = () => {
    ...
    return (<section className="profile-section">
        <div className="container mx-auto">
            ...
            <div
                className="mt-10 middle border py-5 px-7 bg-white flex flex-row items-center gap-[50px] rounded-lg">
                {error ? (<p className="text-red-500 text-lg font-semibold">{error}</p>) : (<>
                    ...
                    <div className="flex flex-row items-center gap-[50px]"
                        ...
                        <div>
                            ...
                            <p className="text-lg mt-2 text-gray-600">{profileData.role}</p>
                            <p className="text-md mt-2 text-gray-600">{profileData.phone}</p>
                        </div>
                    </div>
                </>)}
            </div>

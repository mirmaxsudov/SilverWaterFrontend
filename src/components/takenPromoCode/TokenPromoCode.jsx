...
import {
  fetchAllTakenPromoCodeSearch,
  sendMessageToUser,
} from "../../api/request/admin/takenPromoCode/main.api";
...
const TokenPromoCode = () => {
  ...
  const fetchTakenPromoCodes = async () => {
    try {
      const response = await fetchAllTakenPromoCodeSearch(
        currentPage,
        pageSize,
        searchTerm,
      );
      ...
      <div className="container mx-auto">
        <div className="flex flex-col">
          <div className="flex justify-between items-center">
            <h1 className="text-3xl font-bold">{t("takenPromoCode.title")}</h1>

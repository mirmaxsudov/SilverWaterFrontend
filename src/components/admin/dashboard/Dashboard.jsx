...
const DashboardInfoItem = () => {
    return <div className={"bg-[#fff] p-5 rounded-lg pe-0 shadow w-full h-full border"}>
        <div className={"grid grid-cols-3"}>
            <div className={"col-span-2"}>
                <p>Total User</p>
                <p>40,689</p>
            </div>
            <div className={"icon flex items-center justify-center bg-sky-100 rounded-full h-[60px] w-[60px]"}>
                <svg width="32" height="24" viewBox="0 0 32 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path opacity="0.587821" fillRule="evenodd" clipRule="evenodd"
